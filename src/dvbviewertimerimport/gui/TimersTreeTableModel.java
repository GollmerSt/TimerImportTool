...
public class TimersTreeTableModel extends AbstractTreeTableModel implements TreeTableModel {
	...
	static protected Class<?>[] cTypes = { TreeTableModel.class, // tree
	...
	private static long calcTime(long dateDate, long timeDate) {
		...
		calendarW.clear();
		calendarW.set(calendarD.get(Calendar.YEAR), calendarD.get(Calendar.MONTH), calendarD.get(Calendar.DAY_OF_MONTH),
				calendarT.get(Calendar.HOUR_OF_DAY), calendarT.get(Calendar.MINUTE));
