...
public class ResourceManager {
	...
	public static void copyFile(String destinationPath, String source, ArrayList<String[]> keywords,
		...
		try {
			...
			throw new ErrorClass("Unexpected error on writing file \"" + file.getAbsolutePath() + "\".");
		}
	}
	...
	public static void copyBinaryFile(File destination, String source) {
		...
		try {
			...
			throw new ErrorClass(e1, "Unexpected error on writing file \"" + destination.getAbsolutePath() + "\".");
		}
		try {
