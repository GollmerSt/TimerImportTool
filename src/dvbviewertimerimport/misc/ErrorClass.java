...
public class ErrorClass extends Error {
	...
	public ErrorClass(XMLEvent ev, String errorString) {
		super(errorString + " near line " + Integer.toString(ev.getLocation().getLineNumber()) + ".");
		this.mainError = null;
		this.errorString = errorString + " near line " + Integer.toString(ev.getLocation().getLineNumber()) + ".";
	}
